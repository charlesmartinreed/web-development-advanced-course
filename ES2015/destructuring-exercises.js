...
// my bad, non-operable code
// function createStudent({student = {likesES2015: true, likesJavaScript: true}} = {}) {
// 	if(student.likesES2015 && student.likesJavaScript ) {
// 		return 'The student likes JavaScript and ES2015'
// 	} else if (!student.likesES2015) {
// 		return 'The student likes JavaScript!'
// 	} else if (!student.likesJavaScript) {
...
// Elie's non cheater way
function reverseArray(arr) {
	for(var i=0; i < arr.length/2; i++) {
		[arr[i], arr[arr.legnth - 1 - i]] = [arr[arr.length - 1 - i], arr[i]]
	}
	return arr;
}
