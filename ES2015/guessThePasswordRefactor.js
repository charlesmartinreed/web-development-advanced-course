document.addEventListener("DOMContentLoaded", () => {
  ...
  // instead of using the arguments param, we can use the rest operator to get the classNames as an array like collection
  ...
  function setGuessCount(newCount) {
    ...
    document.getElementById(
      "guesses-remaining"
    ).innerText = `Guesses remaning: ${guessCount}.`;
  }
